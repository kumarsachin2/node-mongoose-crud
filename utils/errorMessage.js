...
exports.errFirstNameEmpty = 'First name must not be empty.';
exports.errLastNameEmpty = 'Last name must not be empty.';
exports.errBirthDateEmpty = 'Birth date must not be empty.';
exports.errStreetEmpty = 'Street name must not be empty.';
